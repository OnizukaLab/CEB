...
python3 main.py --query_templates=all --algs=saved --eval_fns=qerr,ppc,plancost,perr --query_dir=queries/jobm --db_host=card-db --model_dir=results/mlp-pj/imdb/job-m --train_test_split_kind=no_split
```
